...
class Metrics:
    ...
    http_request_time_summary = Summary(
        "request_processing_seconds_s", "Time spent processing request (Summary)"
    )
    http_request_time_histogram = Histogram(
        "request_processing_seconds_h", "Time spent processing request (Histogram)"
    )
